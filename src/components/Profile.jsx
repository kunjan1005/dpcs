...
useEffect(()=>{  if (localStorage.getItem('token') == '' || localStorage.getItem("token") == null) {
  ...
  return (
    <div className='row main-profile mt-2'>
      <div className='card col-lg-8 col-sm-12 m-auto profile-div '>
        ...
        <div className='row '>
          <div className='logout'><NavLink to='/login'><Button variant='outlined'><Logout /></Button></NavLink></div>
