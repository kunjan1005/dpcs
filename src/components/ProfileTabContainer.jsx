    ...
    return (
        <div className='col-lg-8 col-12 m-auto profile_post_container'>
            ...
            <div className="row m-auto">
                ...
                <div className={userReducer.data.is_chef==2?'col-md-2 col-2':"col-md-3 col-3"}><NavLink to='#favriate' className='links'><b>{_.isEmpty(profileTabReducer.favoriate)?<Shimmer/>:profileTabReducer.favoriate.total} </b><h5>FAVORITE</h5></NavLink></div>
                <div className={userReducer.data.is_chef==2?'col-md-2 col-2':"col-md-3 col-3"}><NavLink to='#reviews' className='links'><b>{_.isEmpty(profileTabReducer.reviews)?<Shimmer/>:profileTabReducer.reviews.total} </b><h5>REVIEWS</h5></NavLink></div>
                ...
                {userReducer.data.is_chef==2?<div className={userReducer.data.is_chef==2?'col-md-2 col-2':"col-md-3 col-3"}><NavLink to='#recipes' className='links'><b>{_.isEmpty(profileTabReducer.reviews)?<Shimmer/>:profileTabReducer.reviews.total} </b><h5>RECIPES</h5></NavLink></div>:""}
            ...
            <div className='row post_container'>
                ...
                {tabindex == 'recipes' ? <ChefRecipi data={profileTabReducer.points.item} /> : ""}
            </div>
        </div>
    )
}
